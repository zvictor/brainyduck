...
export type CreatePostMutation = {
  ...
  createPost: {
    ...
    title: string
    _ts: any
    author: { __typename?: 'User'; _id: string; _ts: any; name: string }
  }
}
...
export type CreateUserMutation = {
  __typename?: 'Mutation'
  createUser: { __typename?: 'User'; _id: string; _ts: any; name: string }
}
...
export type DeleteUserMutation = {
  __typename?: 'Mutation'
  deleteUser?: { __typename?: 'User'; _id: string; _ts: any; name: string } | null
}
...
export type PartialUpdatePostMutation = {
  __typename?: 'Mutation'
  partialUpdatePost?: {
    __typename?: 'Post'
    _id: string
...
export type PartialUpdateUserMutation = {
  __typename?: 'Mutation'
  partialUpdateUser?: { __typename?: 'User'; _id: string; _ts: any; name: string } | null
}
...
export type UpdateUserMutation = {
  __typename?: 'Mutation'
  updateUser?: { __typename?: 'User'; _id: string; _ts: any; name: string } | null
}
...
export type FindUserByIdQuery = {
  __typename?: 'Query'
  findUserByID?: { __typename?: 'User'; _id: string; _ts: any; name: string } | null
}
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    partialUpdatePost(
      variables: PartialUpdatePostMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<PartialUpdatePostMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PartialUpdatePostMutation>(PartialUpdatePostDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'partialUpdatePost',
    ...
    partialUpdateUser(
      variables: PartialUpdateUserMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<PartialUpdateUserMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PartialUpdateUserMutation>(PartialUpdateUserDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'partialUpdateUser',
    ...
    findPostByID(
      variables: FindPostByIdQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<FindPostByIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<FindPostByIdQuery>(FindPostByIdDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'findPostByID',
    ...
    sayHello(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SayHelloQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SayHelloQuery>(SayHelloDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'sayHello',
